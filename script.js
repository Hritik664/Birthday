...
function checkDate() {
    ...
    const specialDate = new Date(today.getFullYear(), 7, 8); // 7 is August (0-based index)
    ...
    if (daysDiff > 0) {
        document.querySelector('.days-left').textContent = `There are ${daysDiff} days left until 8th August.`;
